...
export default function MercadosAgrupados({ cards, oddsConsenso }: MercadosAgrupadosProps) {
  ...
  return (
    <div className="space-y-5">
      <h3 className="text-muted-foreground text-[11px] font-semibold uppercase tracking-[0.08em]">🎯 Odds Justas por Mercado</h3>

      {Object.entries(CATEGORIAS).map(([key, cat]) => (
        <div key={key}>
          <h4 className="text-foreground/80 text-xs font-bold mb-3 flex items-center gap-2">
